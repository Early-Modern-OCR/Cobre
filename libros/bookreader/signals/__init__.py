...
from libros.bookreader.models import Repository, Collection, Book
from libros.bookreader.signals import repository, collection, book

if 'libros.bookreader' in settings.INSTALLED_APPS and settings.BOOKREADER_SIGNALS_ENABLED:
