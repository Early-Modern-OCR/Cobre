...
from libros.bookreader.models import Book, Page



log = getLogger('libros.bookreader.views.book')
...
def browse(request, **kwargs):
    ...
    kwargs.setdefault('queryset', book_list)
    kwargs.setdefault('template_object_name', book_list)
    kwargs.setdefault('paginate_by', 25)
    
    print "this is in browse"
...
def pages(request, object_id, **kwargs):
    ...
    print "this is in book.pages.  page is " + str(page)
    ...
    print "Passing page " + str(page) + " as extra_content-sequence_page "
...
def bitstream_metadata(request, object_id):
    book = get_object_or_404(Book, pk=object_id)
    from libros.bookreader.export import bitstream_metadata as export
